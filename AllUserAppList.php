...
<tr bgcolor="#d4d4d4" height="7px">
          ...
          <tr>
            <td bgcolor="#232323" height="78"><p style="font-size:24px; color:#FFF; font-family:Arial, Helvetica, sans-serif; margin-left: 100px;">IT NEW USER LIST: VIEW ALL APPLICATIONS</p></td>
          </tr>
          <tr bgcolor="#d4d4d4" height="7px">
            <td height="7px"><img src="https://intranet.philorch.org/phonelist/grey-spacer.jpg" width="3" height="7"></td>
          </tr>
...
<tr><td>&nbsp;</td></tr>
  <tr><td><font size=2 face="Arial, Helvetica, sans-serif color='#336600' " ><a href='userform.php'>New User</a> | 
	<a href='UserAppList.php?<? echo $uid; ?>'>View New Applications</a> | <a href='AllUserAppList.php?<? echo $uid; ?>'>View All Applications</a> | <a href='userapp_unloading.php'>Logout</a> </font></td></tr><tr><td>&nbsp;</td></tr>
    <tr> 
    <td > 
...
{
print ("<tr>");
print("<form method='post' name='myform' action='userform.php'> <input type='hidden' name='app_no' value='$Row1[application_no]'> ");

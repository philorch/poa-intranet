...
Timeline.GregorianDateLabeller.prototype.labelPrecise=function(A){return SimileAjax.DateTime.removeTimeZoneOffset(A,this._timeZone).toUTCString().replace(/00:00:00 GMT/, '').replace(/00:00:00 UTC/, '');/*Lauren J. added ".toUTCString().replace(/00:00:00 GMT/, '').replace(/00:00:00 UTC/, '');" to remove the GMT and UTC timestamp on 6/26/12*/
};

...
<table width="600" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <th bgcolor="#FFFFFF" scope="col"><a href="index.html"><img src="images/hd_index.gif" width="600" height="100" border="0"></a></th>
  </tr>
  <tr>
  ...
  <tr>
    <td bgcolor="#FFFFFF" scope="col"><div align="left">
      <table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td valign="top" scope="col"><table width="100%" cellpadding="0" cellspacing="5">
            <tr>
              <td height="279" valign="top" scope="col"><font face="Arial, Helvetica, sans-serif" color="#990000" size="12">IT New User Form</font></p>                
                <?php
...
Function PrintForm($form_type,$dsp_application_no) {
   ...
   //$ldap_host = "ldaps://apollo.philorch.org/";
   //$ldap_port = "636";
   $ldap_host = "ldap://POAGC02.philorch.org/";
   $ldap_port = "389";
   $base_dn = "OU=Groups,DC=philorch,DC=org";
   $username="andrewt";
   $passwd="A3rial1";
   //$filter = "(objectClass=groupWiseDistributionList)";
   //$filter = "(memberOf=)";
   $filter = "(|(cn=*))";
   //$ldap_user ="cn=$username,o=phl_orch";
   //$ldap_pass = "$passwd";
   $ldap_user = "$username";
   $ldap_pass = "$passwd";
   $nds_stuff = array("cn");
   $connect = @ldap_connect("ldap://POAGC02.philorch.org/",389) or die("Could not connect to POAGC02 LDAP server!");
   ...
   $rowCnt = 5; // show 5 columns
   print("<b>Please check off all email groups</b> -- $_POST[info]");
   print("<table > ");
   ...
   for($i = 0; $i<$info["count"]; $i++)
   {
      ...
      $dataval = $info[$j][cn][0];
      print ("<td><font face=\"Arial, Helvetica, sans-serif\" size=\"2\">$dataval");  
...
// List Printers to give access to.
   ...
   $info = @ldap_get_entries($connect, $read);
   $rowCnt =5;
   print("<font face='Arial, Helvetica, sans-serif' size='2'> <b> Please check off all printers</b></font>");
   print("<table > ");
   ...
   for($i = 0; $i<$info["count"]; $i++)
   {
       for($j = 0; $j<$info[$i]["count"]; $j++)
     {
      ...
      $data = $info[$i][$j];
      $dataval= substr($info[$i][$data][0],2);

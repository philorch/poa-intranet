...
if ($_REQUEST['option']) {
  ...
  echo "If you have reached this page in error please <a href='phonelist.html'>Click Here</a>.\n";
  exit;
}
...
function mylogin($lastname)
{
  ...
  if ($ldap) {
    ...
    $bind_results = @ldap_bind($ldap,"cn=ldap,o=phl_orch", "") or die("Could not log you in please check your UserName and Password and try again.");
    ...
    $filter="(sn=" . $lastname . "*)";
    //array attributes
    $nds_stuff = array(  "sn","fullname", "ou", "mail", "cn","telephonenumber",  "x121address","title");
...
<body bgcolor='#FFFFFF' text='#000000' link='#FFFFFF' vlink='#CCCCCC' alink='#666666'>
      ...
      <center><h1><font face='Arial, Helvetica, sans-serif' color='#32603f'>POA Phone List</font></h1></center>
...
<tr>
                ...
                <td valign='center' align='left' bgcolor='#cccccc'><font face='Arial, Helvetica, sans-serif' size='2'><b>Full Name,&nbsp;&nbsp;&nbsp;</b></font></td>
                <td valign='center' align='left' bgcolor='#cccccc'><font face='Arial, Helvetica, sans-serif' size='2'><b>Phone,&nbsp;&nbsp;&nbsp;</b></font></td>
                <td valign='center' align='left' bgcolor='#cccccc'><font face='Arial, Helvetica, sans-serif' size='2'><b>Fax,&nbsp;&nbsp;&nbsp;</b></font></td>
...
echo "       
         <tr>
                ...
                <td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["fullname"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
	<td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["ou"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
	<td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["mail"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
	<td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["cn"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
                <td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["telephonenumber"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
		<td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["x121address"][0] . "&nbsp;&nbsp;&nbsp;</font></td>
		<td valign='center' align='left' bgcolor='#ffffff'><font face='Arial, Helvetica, sans-serif' size='2'>" . $info[$i]["title"][0] . "</font></td>
                </tr>
...
echo "<a href='./phonelist.html'>Click here to return to the search.</a>
